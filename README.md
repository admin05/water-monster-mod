...
- Before the first Water Monster summoning, a shadow guide can naturally appear in dark Overworld areas. It gives the altar map and eerie expedition journal only once.
...
- 首次召唤水怪之前，引路影子可在主世界暗处自然刷新。祭坛地图和探险恐怖氛围的书只会给一次。
